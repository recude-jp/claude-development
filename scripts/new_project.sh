...
echo "以下のコマンドを実行してクローンしてください："
echo ""
echo "git clone https://$GITHUB_USER:$PAT@github.com/$NEW_REPO_FULL.git \$(pwd)/mnt/$NEW_REPO_NAME"
echo ""
echo "クローンが完了したら \$(pwd)/mnt/$NEW_REPO_NAME/CLAUDE.md を読み込み、"
